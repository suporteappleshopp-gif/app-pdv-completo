          ...
          <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full">
            ...
            <div className="p-6 space-y-4">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white py-3 rounded-lg font-semibold transition-all shadow-lg"
              >
                Realizar Pagamento
              </button>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex flex-col items-end">
                {/* Botão Sair pequeno acima do relógio */}
                <button
                  onClick={sair}
                  className="bg-red-600 hover:bg-red-700 text-white px-2 py-1 rounded-md flex items-center space-x-1 transition-all shadow-sm mb-1"
                  title="Sair"
                >
                ...
                {/* Dias restantes acima do relógio - APENAS para usuários COM mensalidade */}
                {podeUsarApp && diasRestantes > 0 && diasRestantes < 999 && !usuarioSemMensalidade && (
                  <div className="flex items-center space-x-1 px-2 py-0.5 rounded-md bg-blue-100 text-blue-800 mb-1">
